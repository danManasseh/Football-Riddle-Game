...
#     riddles = json.load(f)
with open(os.path.join(os.path.dirname(__file__), "football_riddles.json"), "r", encoding="utf-8") as f:
    riddles = json.load(f)
...
def matches(user_answer, correct_answers):
